...
![image.png](/blog/typescript-cli-aws-batch/project-folder-structure.png)
...
* Create a new private repository named `typescript-cli`.
    ...
    ![aws-ecr-create-repo.png](/blog/typescript-cli-aws-batch/aws-ecr-create-repository.png)
...
![aws-iam-create-role-1.png](/blog/typescript-cli-aws-batch/aws-iam-create-role.png)

Then, search for the 'Elastic Container Service' and select 'Elastic Container Service Task'.

![aws-iam-create-role-2.png](/blog/typescript-cli-aws-batch/aws-iam-select-ecs-task.png)
...
![aws-iam-create-role-3.png](/blog/typescript-cli-aws-batch/aws-iam-add-task-execution-policy.png)

Finally, we just choose a name for the role, and click 'Create role'. Let's name it 'ecsTaskExecutionRole'.

![aws-iam-create-role-4.png](/blog/typescript-cli-aws-batch/aws-iam-name-task-execution-role.png)
...
![aws-batch-compute-environment.png](/blog/typescript-cli-aws-batch/aws-batch-compute-environment.png)
...
![aws-batch-job-queue.png](/blog/typescript-cli-aws-batch/aws-batch-job-queue.png)
...
![aws-batch-job-definition.png](/blog/typescript-cli-aws-batch/aws-batch-job-definition.png)
...
![aws-batch-list-job-definitions.png](/blog/typescript-cli-aws-batch/aws-batch-job-definitions.png)
...
![aws-batch-run-job.png](/blog/typescript-cli-aws-batch/aws-batch-submit-job.png)

After that, we are able to check the running jobs on the 'Jobs' tab. (Click the refresh button if nothing shows up)

![aws-batch-list-jobs.png](/blog/typescript-cli-aws-batch/aws-batch-jobs.png)

If we click on a job, we can see its details.

![aws-batch-job-status.png](/blog/typescript-cli-aws-batch/aws-batch-job-details.png)

And also check the logs.

![aws-batch-logs.png](/blog/typescript-cli-aws-batch/aws-batch-cloudwatch-logs.png)
